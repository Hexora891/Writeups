...
> **Note**: This writeup contains image placeholders. To see the actual screenshots, add your real HackTheBox images to `assets/images/hackthebox/Editor/` and update the image paths below.
...
![Hibernate Configuration](hibernate-config.png)
...
![Netdata Service](netdata-service.png)
...
![Version Information](version-info.png)
...
1. **Create directory**: `mkdir -p assets/images/hackthebox/Editor/`
...
3. **Image syntax**: Use `![Description](filename.png)` (Hugo will automatically process assets)
